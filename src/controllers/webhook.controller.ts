...
export async function dialerStatusController(request: FastifyRequest, reply: FastifyReply) {
  ...
  try {
    const result = await webhookService.registrarStatusDialer(parsed.data);
